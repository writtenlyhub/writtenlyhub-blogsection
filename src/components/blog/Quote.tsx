...
export function Quote({ data }: { data: QuoteData | null }) {
  ...
  return (
    <blockquote className="my-10 max-w-[75ch] mx-auto lg:mx-0 w-full p-6 md:p-8 bg-writtenly-navy text-white rounded-2xl relative overflow-hidden shadow-md border-none">
