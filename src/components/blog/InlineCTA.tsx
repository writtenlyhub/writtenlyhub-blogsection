...
export function InlineCTA({ data }: { data: CTAData | null }) {
  ...
  return (
    <div className="my-10 max-w-[75ch] mx-auto lg:mx-0 w-full p-6 md:p-8 bg-writtenly-navy text-white rounded-2xl shadow-md border border-primary-container flex flex-col items-center justify-between gap-6">
      <div>
