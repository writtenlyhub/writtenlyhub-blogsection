      ...
      >
        ...
        >
          ...
          <nav className="flex flex-col p-6 gap-6 overflow-y-auto" data-lenis-prevent="true">
            ...
            <Link onClick={closeMenu} className="font-headline-md text-headline-md font-bold text-white/80 hover:text-writtenly-orange transition-colors" href="/write-for-us">Write For Us</Link>
          </nav>
